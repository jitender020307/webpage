...
export const LEGAL_DOCUMENTS: DocumentMeta[] = [
  ...
  {
    title: 'MERKLE AUDIT TRAIL CERTIFICATE',
    docNumber: 'AUDIT-LOG-BLK-9842',
    type: 'IMMUTABLE CONSENSUS PROOF',
  ...
  },
  {
    ...
    docNumber: 'SZR-CCTV-HASH-009',
    type: 'CHAIN OF CUSTODY',
    stampText: 'HARDWARE SIGNED',
    stampColor: '#8b5cf6',
    hash: '9f86d081884c7d659a2feaa0c55ad015',
    date: '2026-08-28 12:30:19 IST',
  },
  {
    title: 'PERPETUAL ARCHIVAL WARRANT',
    docNumber: 'ARC-SEAL-2026-FINAL',
    type: 'VAULT ENCRYPTED DOCKET',
    stampText: 'LOCKED & SEALED',
    stampColor: '#10b981',
